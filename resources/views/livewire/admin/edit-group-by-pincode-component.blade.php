...
<div class="page-title">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <h3> Edit Group By Pincode</h3>
       {{ Breadcrumbs::render('editGroupByPincodes',$group_by_pincode_id) }}
      </div>
    </div>
  </div>
</div>
  ...
  @endif   
    ...
    <div class="col-md-12">
      <div class="panel panel-white">
        ...
        <form enctype="multipart/form-data" class="form-horizontal" method="post" wire:submit.prevent="editGroupByPincode">
