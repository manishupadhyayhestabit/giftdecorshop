...
<div class="page-title">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <h3> Categories</h3>
       {{ Breadcrumbs::render('editCategory', $this->category_id) }}
      </div>
    </div>
  </div>
</div>
    ...
    <div class="col-md-12">
      <div class="panel panel-white">
        <div class="panel-body">
          <form enctype="multipart/form-data" class="form-horizontal" method="post" wire:submit.prevent="updateCategory">
            ...
            <div class="form-group">
              <label for="parent_id" class="col-sm-2 control-label optional">Parent</label>
              <div class="col-sm-10">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <textarea placeholder="Description" class="form-control summernote" rows="5" cols="5" wire:model="description">{{ $description }}</textarea>
              </div>
            </div>
            <div class="form-group">
              <label for="sortDescription" class="col-sm-2 control-label optional">Sort Description</label>
              <div class="col-sm-10">
                <textarea placeholder="Sort Description" class="form-control" rows="5" cols="5" wire:model="sort_description"></textarea>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-10 add-feature-image">
                ...
                <div wire:loading wire:target="feature_image">Uploading...</div>
                @if ($feature_image)
                  @if ($isFeatureImageUploaded)
                    <img src="{{ $feature_image->temporaryUrl() }}" width="50" />
                  @else
                    <img src="{{ config('AWS_URL','http://gds-image.s3-ap-south-1.amazonaws.com') }}/category/{{ $slug }}/small/{{ $feature_image }}" width="50"/>
                  @endif
                @endif
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-10 add-banner-image">
                ...
                @if ($banner_image)
                  @if ($isBannerImageUploaded)
                    <img src="{{ $banner_image->temporaryUrl() }}" width="50" />
                  @else  
                    <img src="{{ config('AWS_URL','http://gds-image.s3-ap-south-1.amazonaws.com') }}/category/{{ $slug }}/small/{{ $banner_image }}" width="50"/>
                  @endif
                @endif
              </div>
            </div>
