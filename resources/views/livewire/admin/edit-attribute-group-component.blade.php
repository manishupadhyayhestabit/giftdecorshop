...
<div class="page-title">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <h3> {{ __('Edit Attribute Group') }}</h3>
       {{ Breadcrumbs::render('editAttributeGroup', $this->attri_group_id) }}
      </div>
    </div>
  </div>
</div>
  ...
  @endif  
    ...
    <div class="col-md-12">
      <div class="panel panel-white">
        ...
        <form enctype="multipart/form-data" class="form-horizontal" method="post" wire:submit.prevent="updateAttributeGroup">
        ...
        <div class="form-group">
          <div class="col-sm-10 col-md-offset-2">
            <button type="submit" class="btn btn-primary">Update Attribute Group</button>
          </div>
        </div>
        </form>
        </div>
