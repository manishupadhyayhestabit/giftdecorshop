<div>
    ...
    <div class="osahan-listing px-3 bg-white">
      <div class="row border-bottom border-top">
        ...
        <div class="col-6 p-0">
          <div class="list-card-image"> <a href="product_details.html" class="text-dark">
            ...
            <div class="p-3"> <img src="{{ asset('frontend/mobile/img/listing/v2.jpg') }}" class="img-fluid item-img w-100 mb-3">
              <h6>Cakes</h6>
              <div class="d-flex align-items-center">
      ...
      <div class="row border-bottom">
        <div class="col-6 p-0 border-right">
          <div class="list-card-image"> <a href="product_details.html" class="text-dark">
            ...
            <div class="p-3"> <img src="{{ asset('frontend/mobile/img/listing/v3.jpg') }}" class="img-fluid item-img w-100 mb-3">
              <h6>Cakes</h6>
              <div class="d-flex align-items-center">
        ...
        <div class="col-6 p-0">
          <div class="list-card-image"> <a href="product_details.html" class="text-dark">
            ...
            <div class="p-3"> <img src="{{ asset('frontend/mobile/img/listing/v4.jpg') }}" class="img-fluid item-img w-100 mb-3">
              <h6>Cakes</h6>
              <div class="d-flex align-items-center">
                <h6 class="price m-0 text-success">$0.8/kg</h6>
                <a href="cart.html" class="btn btn-success btn-sm ml-auto">+</a> </div>
      ...
      <div class="row border-bottom">
        <div class="col-6 p-0 border-right">
          <div class="list-card-image"> <a href="product_details.html" class="text-dark">
            ...
            <div class="p-3"> <img src="{{ asset('frontend/mobile/img/listing/v5.jpg') }}" class="img-fluid item-img w-100 mb-3">
              <h6>Cakes</h6>
              <div class="d-flex align-items-center">
                <h6 class="price m-0 text-success">$1.8/kg</h6>
                <a class="ml-auto" href="cart.html">
        ...
        <div class="col-6 p-0">
          <div class="list-card-image"> <a href="product_details.html" class="text-dark">
            <div class="member-plan position-absolute"><span class="badge m-3 badge-success">10%</span></div>
            <div class="p-3"> <img src="{{ asset('frontend/mobile/img/listing/v6.jpg') }}" class="img-fluid item-img w-100 mb-3">
              <h6>Cakes</h6>
              <div class="d-flex align-items-center">
                <h6 class="price m-0 text-success">$0.8/kg</h6>
                <a href="cart.html" class="btn btn-success btn-sm ml-auto">+</a> </div>
      ...
      <div class="row border-bottom">
        <div class="col-6 p-0 border-right">
          <div class="list-card-image"> <a href="product_details.html" class="text-dark">
            <div class="member-plan position-absolute"><span class="badge m-3 badge-warning">5%</span></div>
            <div class="p-3"> <img src="{{ asset('frontend/mobile/img/listing/v7.jpg') }}" class="img-fluid item-img w-100 mb-3">
              <h6>Cakes</h6>
              <div class="d-flex align-items-center">
                <h6 class="price m-0 text-success">$2.5/kg</h6>
                <a href="cart.html" class="btn btn-success btn-sm ml-auto">+</a> </div>
        ...
        <div class="col-6 p-0">
          <div class="list-card-image"> <a href="product_details.html" class="text-dark">
            <div class="member-plan position-absolute"><span class="badge m-3 badge-warning">15%</span></div>
            <div class="p-3"> <img src="{{ asset('frontend/mobile/img/listing/v8.jpg') }}" class="img-fluid item-img w-100 mb-3">
              <h6>Cakes</h6>
              <div class="d-flex align-items-center">
                <h6 class="price m-0 text-success">$0.8/kg</h6>
                <a href="cart.html" class="btn btn-success btn-sm ml-auto">+</a> </div>
      ...
      <div class="row border-bottom">
        <div class="col-6 p-0 border-right">
          <div class="list-card-image"> <a href="product_details.html" class="text-dark">
            <div class="member-plan position-absolute"><span class="badge m-3 badge-warning">5%</span></div>
            <div class="p-3"> <img src="{{ asset('frontend/mobile/img/listing/v9.jpg') }}" class="img-fluid item-img w-100 mb-3">
              <h6>Cakes</h6>
              <div class="d-flex align-items-center">
                <h6 class="price m-0 text-success">$2.5/kg</h6>
                <a href="cart.html" class="btn btn-success btn-sm ml-auto">+</a> </div>
        ...
        <div class="col-6 p-0">
          <div class="list-card-image"> <a href="product_details.html" class="text-dark">
            <div class="member-plan position-absolute"><span class="badge m-3 badge-warning">15%</span></div>
            <div class="p-3"> <img src="{{ asset('frontend/mobile/img/listing/v10.jpg') }}" class="img-fluid item-img w-100 mb-3">
              <h6>Cakes</h6>
              <div class="d-flex align-items-center">
                <h6 class="price m-0 text-success">$0.8/kg</h6>
                <a href="cart.html" class="btn btn-success btn-sm ml-auto">+</a> </div>
      ...
      <div class="row border-bottom">
        <div class="col-6 p-0 border-right">
          <div class="list-card-image"> <a href="product_details.html" class="text-dark">
            <div class="member-plan position-absolute"><span class="badge m-3 badge-warning">5%</span></div>
            <div class="p-3"> <img src="{{ asset('frontend/mobile/img/listing/v11.jpg') }}" class="img-fluid item-img w-100 mb-3">
              <h6>Cakes</h6>
              <div class="d-flex align-items-center">
                <h6 class="price m-0 text-success">$2.5/kg</h6>
                <a href="cart.html" class="btn btn-success btn-sm ml-auto">+</a> </div>
        ...
        <div class="col-6 p-0">
          <div class="list-card-image"> <a href="product_details.html" class="text-dark">
            <div class="member-plan position-absolute"><span class="badge m-3 badge-warning">15%</span></div>
            <div class="p-3"> <img src="{{ asset('frontend/mobile/img/listing/v12.jpg') }}" class="img-fluid item-img w-100 mb-3">
              <h6>Cakes</h6>
              <div class="d-flex align-items-center">
                <h6 class="price m-0 text-success">$0.8/kg</h6>
                <a href="cart.html" class="btn btn-success btn-sm ml-auto">+</a> </div>
  ...
  <div class="row m-0 text-center border-bottom border-top fixed-bottom bg-white">
    <div class="col-6 p-0 border-right"> <a href="#" data-toggle="modal" data-target="#exampleModal" class="btn text-muted"><i class="icofont-filter mr-2"></i> Filter</a> </div>
    <div class="col-6 p-0"> <a href="#" data-toggle="modal" data-target="#exampleModal" class="btn text-muted"><i class="icofont-signal mr-2"></i> Sort</a> </div>
  </div>
