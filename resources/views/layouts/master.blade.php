...
<link href="{{ asset('plugins/jquery-ui/jquery-ui-timepicker-addon.css') }}" rel="stylesheet" type="text/css" />
...
<script type="text/javascript" src="{{ asset('plugins/jquery-ui/jquery-ui-timepicker-addon.js') }}"></script>
